...
def create_reasoning_agent():
    reasoning_agent = Agent(
        ...
        instructions="You are responsible for compiling the information from the previous steps into a comprehensible summary and conclusion as the output." +
                    "Please organization the nutritional information as a chart and provide a bullet list of possible alternative healthy options."
    )
...
workflow = Workflow(
    ...
    steps=[
        Parallel(csv_reader_agent, web_agent_step),
        generation_step],
